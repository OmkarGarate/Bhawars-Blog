      ...
      <Routes>
        <Route path="/" element={<U_main/>}>
          ...
          <Route path="/asbuilt" element={<AsBuilt/>}>
            ...
            <Route path="/asbuilt/popular" element={<PopularUp cat="As Built"/>}/>
          ...
          <Route path="/procegg" element={<ProcessEng/>}>
            ...
            <Route path="/procegg/popular" element={<PopularUp cat="Process Engineering"/>}/>
          ...
          <Route path="/detdes" element={<DetailedDes/>}>
            ...
            <Route path="/detdes/popular" element={<PopularUp cat="Detailed Design"/>}/>
          ...
          <Route path="/officelife" element={<OfficeLife/>}>
            ...
            <Route path="/officelife/popular" element={<PopularUp cat="Office Life"/>}/>
